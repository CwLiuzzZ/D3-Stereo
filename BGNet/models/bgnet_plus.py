...
class BGNet_Plus(SubModule):
    ...
    def forward(self, left_input, right_input):     
        ...
        # print(final_cost_volume[0,:,199,300])
        # print(final_cost_volume[0,:,200,300])
        # print(final_cost_volume[0,:,201,300])
        ...
        # print(half_disp[0,:,199,300])
        # print(half_disp[0,:,200,300])
        # print(half_disp[0,:,201,300])
        # exit()
        ...
        return out1,out2,left_gwc_feature,right_gwc_feature
    
    def DDFM(self,x):
        feature_list  = self.feature_extraction.DDFM(x)
        return feature_list