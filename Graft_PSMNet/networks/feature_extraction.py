...
from Graft_PSMNet.networks.resnet import ResNet, Bottleneck, BasicBlock_Res
from Graft_PSMNet.networks.vgg import vgg16
...
class VGG_Feature(nn.Module):
    def __init__(self, fixed_param):
        ...
        self.fe.load_state_dict(
            torch.load('../toolkit/models/graft/vgg16-397923af.pth'))
