...
import math
import sys
sys.path.append('../LacGwcNet')
from networks.submodule import convbn_3d, feature_extraction, DisparityRegression
from networks.deformable_refine import DeformableRefineF
    ...
    def forward(self, left, right, gt_left=None):
        ...
        if self.training:
            ...
            if self.refine:
                ...
                return pred3,refimg_fea,targetimg_fea

    def DDFM(self,x):
        feature = self.feature_extraction.DDFM(x)
        return feature